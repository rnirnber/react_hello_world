...
var HeaderElements = /** @class */ (function (_super) {
    __extends(HeaderElements, _super);
...
var FormElement = /** @class */ (function (_super) {
    ...
    function FormElement() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.initial_keyup_detected_map = {
            "name": false,
            "phone": false,
            "email": false,
            "msg": false
        ...
        _this.submitButtonDelegate = (function () {
            if (_this.form_submitted) {
                return;
            }
            var error_msg = "All form fields must be provided in a valid format.";
            var show_missing_fields_message = false;
            Object.keys(_this.initial_keyup_detected_map).forEach(function (key) {
                if (_this.initial_keyup_detected_map[key] === false) {
            ...
            var form_elements = Array.prototype.slice.call(document.querySelectorAll(".form_input input, .form_input textarea"));
            var form_data = new FormData();
            var form_fields = [];
            form_elements.map(function (element) {
                var error_msg_root = element.parentElement.previousSibling;
                var error_span = error_msg_root.querySelector(".error");
        ...
        _this.keyUpDelegate = (function (ev) {
            ...
            var id = element.id;
            _this.initial_keyup_detected_map[id] = true;
                            ...
                            React.createElement("div", { className: "fields_root" },
                                ...
                                React.createElement("div", { className: "error_msg" },
                                    React.createElement("p", null,
                                        ...
                                        React.createElement("span", { className: "actual_msg" }, "A name must be provided."))),
                                ...
                                React.createElement("div", { className: "error_msg" },
                                    React.createElement("p", null,
                                        React.createElement("span", { className: "error" }, "\uD83D\uDEAB"),
                                        React.createElement("span", { className: "success" }, "\u2713"),
                                        React.createElement("span", { className: "actual_msg" }, "Phone is required."))),
                                React.createElement("div", { className: "form_input" },
                                ...
                                React.createElement("div", { className: "error_msg" },
                                    React.createElement("p", null,
                                        React.createElement("span", { className: "error" }, "\uD83D\uDEAB"),
                                        React.createElement("span", { className: "success" }, "\u2713"),
                                        React.createElement("span", { className: "actual_msg" }, "A message is required."))),
                                React.createElement("div", { className: "form_input" },
                                    React.createElement("textarea", { id: "msg", onKeyUp: _this.keyUpDelegate })),
                                React.createElement("div", { className: "submit_button", onClick: _this.submitButtonDelegate }, "Submit"))))));
        });
        return _this;
    }
    return FormElement;
...
var FooterElement = /** @class */ (function (_super) {
    ...
    function FooterElement() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.render = (function () {
            return React.createElement("div", { className: "pseudo_table", id: "footer_root" },
                React.createElement("div", { className: "pseudo_td" },
                    React.createElement("div", { className: "footer_spacing" }),
                    React.createElement("table", { className: "social_media_links_root" },
                        React.createElement("tbody", null,
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("a", { href: "#", className: "social_media_link twitter_link" },
                                        React.createElement("img", { src: "/images/twitter_logo.jpg" }))),
                                React.createElement("td", null,
                                    React.createElement("a", { href: "#", className: "social_media_link linked_in_link" },
                                        React.createElement("img", { src: "/images/linked_in_logo.jpg" }))),
                                React.createElement("td", null,
                                    React.createElement("a", { href: "#", className: "social_media_link instagram_link" },
                                        React.createElement("img", { src: "/images/instagram_logo.jpg" })))))),
                    React.createElement("div", { className: "footer_spacing" }),
                    React.createElement("table", { className: "footer_links_table" },
                        React.createElement("tbody", null,
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("div", { className: "first_link_set" },
                                        React.createElement("a", { href: "#" }, "Claim Your Venue"),
                                        React.createElement("a", { href: "#" }, "Venue Login"))),
                                React.createElement("td", null,
                                    React.createElement("div", { className: "second_link_set" },
                                        React.createElement("a", { href: "#" }, "Terms and Conditions"),
                                        React.createElement("a", { href: "#" }, "Privacy Policy"))),
                                React.createElement("td", null,
                                    React.createElement("div", { className: "third_link_set link_set_desktop_only" },
                                        React.createElement("p", null,
                                            React.createElement("span", null, "Default"),
                                            React.createElement("span", { className: "third_link_whitespace" }))))),
                            React.createElement("tr", { className: "third_link_set link_set_mobile_only" },
                                React.createElement("td", { colSpan: "2" },
                                    React.createElement("div", { className: "default_wrapper" },
                                        React.createElement("div", { className: "third_link_set link_set_mobile_only_div" },
                                            React.createElement("p", null,
                                                React.createElement("span", null, "Default"),
                                                React.createElement("span", { className: "third_link_whitespace" })))))))),
                    React.createElement("div", { className: "footer_spacing" })));
...
ReactDOM.render([React.createElement(HeaderElements, null), React.createElement(FormElement, null), React.createElement(FooterElement, null)], document.getElementById('root'));
